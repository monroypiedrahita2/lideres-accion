...
import { AsignarCarreraModel } from '../../../../models/carrera/carrera.model';
...
@Component({
    ...
    templateUrl: './dialog-asignar-carrera-vehiculo.component.html',
    styleUrls: ['./dialog-asignar-carrera-vehiculo.component.scss']
})
export class DialogAsignarCarreraVehiculoComponent implements OnInit {
    form: FormGroup;
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<DialogAsignarCarreraVehiculoComponent>,
        ...
        // Add additional data if needed, e.g. status
         const newCarrera: AsignarCarreraModel = {
            ...
            datosConductorAprobado: {
                ...
                foto: this.data.vehiculo.foto || '',
                placaVehiculo: this.data.vehiculo.placa,
                modeloVehiculo: this.data.vehiculo.nombreModelo,
