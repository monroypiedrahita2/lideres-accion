...
export class TabCarrerasComponent implements OnInit {
    ...
    async aprobarConductor(carrera: CreateCarreraModel, postulacion: PostuladosIdsModel) {
        ...
        try {
            await this.carreraService.aprobarConductor(carrera.id!, postulacion.id, ''); // Conductor ID empty for now as agreed
            alert('Conductor aprobado y carrera en ruta.');
        } catch (error) {
